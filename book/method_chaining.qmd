...
- The Polars code looks pretty good here next to Pandas. It's less clunky and more conducive to fluent programming. I've noticed some people are under the impression that you should only use Polars when you need it (implying you need it less often than Pandas), but I would argue the above examples show that it's better for small data too.
