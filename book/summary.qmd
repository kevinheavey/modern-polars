...
Suppose you have a bunch of important stuff in another library that works fine, even if it's a bit slow. Maybe it doesn't have good tests. Switching to another library is tricky may not be worth it here. Even if Polars is bug-free, various default behaviours might differ from your expectations.
