...
line = mean_std_pl.plot.line(x="time", y="mean", ylabel="Close ($)")
line * mean_std_pl.plot.area(x="time", y="lower", y2="upper", alpha=0.25) 
```
## Pandas
``` {python}
